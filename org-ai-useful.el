...
`HOW' is a string describing how the code should be modified."
  ...
  In the following I will show you an instruction and then a code snippet. I want you to modify the code snippet based on the instruction. Only output the modified code.
  Do not include any explanation.
  Also do not include backtick fences or language/syntax-highlighting identifiers before and after the response.
  Return just the modified code itself (bare).
